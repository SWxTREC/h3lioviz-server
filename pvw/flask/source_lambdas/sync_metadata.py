""" This lambda function syncs the items in the H3liovizRunCacheInfo DynamoDB table with the metadata in S3. This function is intended to be invoked manually."""
import json
import os
